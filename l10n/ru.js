OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Теперь модераторы могут закреплять сообщения, чтобы они оставались вверху",
    "- Schedule a message to send it at a later time" : "- Запланировать сообщение к отправке в указанное время",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Метки, группировка и сортировка для организации списка обсуждений",
    "- Voice-rooms to connect spontaneously" : "- Голосовые комнаты для спонтанного общения",
    "- Presets for quick conversation configuration during creation" : "- Пресеты для быстрой настройки обсуждения при создании",
    "- Direct calls from profile menus for calls within other apps" : "- Прямые звонки из меню профиля для вызовов внутри других приложений",
    ...
    "{actor} preserved the conversation" : "{actor} защитил(а) обсуждение",
    "You preserved the conversation" : "Вы защитили обсуждение",
    "An administrator preserved the conversation" : "Администратор защитил обсуждение",
    "{actor} stopped preserving the conversation" : "{actor} прекратил(а) защищать обсуждение",
    "You stopped preserving the conversation" : "Вы прекратили защищать обсуждение",
    "An administrator stopped preserving the conversation" : "Администратор прекратил защищать обсуждение",
    ...
    "System added you" : "Система добавила вас",
    "System added {user}" : "Система добавила {user}",
    ...
    "{actor} pinned a message" : "{actor} закрепил(а) сообщение",
    "You pinned a message" : "Вы закрепили сообщение",
    "{actor} unpinned a message" : "{actor} открепил(а) сообщение",
    "Message was automatically unpinned" : "Сообщение было автоматически откреплено",
    "You unpinned a message" : "Вы открепили сообщение",
    ...
    "Conversation subfolders are disabled" : "Подпапки для обсуждений отключены",
    "Storage quota exceeded" : "Превышена квота хранилища",
    "Could not prepare conversation folder" : "Не удалось подготовить папку для обсуждения",
    "File not found" : "Файл не найден",
    "Path must point to a file" : "Путь должен указывать на файл",
    "File is not inside the conversation draft folder for this room" : "Файл не найден в черновой папке для этого обсуждения",
    ...
    "Missing %s field in header line" : "Отсутствует поле %s в строке заголовка",
    ...
    "Call via Talk" : "Звонок через Talk",
    "Channel" : "Канал",
    "Default" : "По умолчанию",
    "Send messages, create threads, and start voice and video calls." : "Отправляйте сообщения, создавайте темы и начинайте аудио- и видеовызовы.",
    "Presentation" : "Презентация",
    "Restricted conversation for internal presentations." : "Ограниченное общение для внутренних презентаций.",
    "Voice room" : "Голосовой чат",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Напрямую присоединяйтесь к вызову: идеально для спонтанных встреч",
    "Webinar" : "Вебинар",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Ограниченное общение с включенным лобби, идеально подходит для публичных вебинаров.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "«Client Push» установлен, это улучшает скорость получения уведомлений в Talk",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "«{notify_push}»  не установлен, это может привести к замедленному получению уведомлений в Talk",
    ...
    "Open in full application" : "Открыть в полной версии приложения",
    ...
    "Enable live transcription (generated by AI)" : "Включить онлайн-транскрипцию (генерируется с ИИ)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Включить онлайн-транскрипцию (приложение не установлено)",
    "Disable live translation" : "Отключить онлайн-перевод",
    "Enable live translation (generated by AI)" : "Включить онлайн-перевод (генерируется с ИИ)",
    "Original language" : "Исходный язык",
    "Live translations app is not installed" : "Приложение для онлайн-перевода не установлно",
    "Original language: {languageName}" : "Язык оригинала: {languageName}",
    "Translated language" : "Язык для перевода",
    "Translated language: {languageName}" : "Язык для перевода: {languageName}",
    ...
    "Failed to enable live translations" : "Ошибка при включении онлайн-перевода",
    ...
    "Disable" : "Отключить",
    "Enable" : "Включить",
    "The bot is not available anymore" : "Бот больше не доступен",
    ...
    "Participants can use all available features." : "Участники могут использовать все доступные функции.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Участники получают ограниченный набор функций до тех пор, пока модератор вручную не предоставит дополнительные разрешения.",
    ...
    "Live transcriptions app is not installed" : "Приложение для онлайн-транскрипции не установлно",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Обсуждение защищено. Оно не может быть удалено, и история сообщений не может быть очищена.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Эта опция не может быть изменена, пока обсуждение защищено.",
    ...
    "The entered token does not match the conversation token" : "Введённый токен не совпадает с токеном обсуждения",
    "Preserve conversation" : "Защитить обсуждение",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Пока защищено, это обсуждение не может быть удалено, история сообщений не может быть очищена, и настройки доступа для гостей и зарегистрированных пользователей не могут быть изменены.",
    "Only the owner can change whether this conversation is preserved." : "Только владелец может защитить обсуждение.",
    ...
    "Stop preserving" : "Прекратить защищать",
    "Stop preserving conversation" : "Прекратить защищать обсуждение",
    "Conversation token" : "Токен беседы",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Если вы прекратите защищать это обсуждение, оно может быть удалено, история сообщений может быть очищена, и настройки доступа для гостей и зарегистрированных пользователей могут быть изменены.",
    "Conversation" : "Обсуждение",
    "To confirm, type the conversation token into the field below:" : "Для подтверждения, введите токен обсуждения в поле ввода ниже:",
    "Ongoing" : "Текущий",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Здесь показаны события календаря со ссылкой на разговор в качестве места",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Содержимое в формате «сomma-separated values» (CSV):<br/>- Строка заголовка обязательна и должна совпадать с {sample1} или только {sample2}<br/>- Одна запись на строку (например, {sample3})",
    ...
    "Remove all tags" : "Удалить все теги",
    "Rename tag" : "Переименовать метку",
    "Delete tag" : "Удалить метку",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Вы действительно хотите удалить \"{name}\"? Разговоры с этим тегом будут перемещены в раздел «Другое».",
    "Move up" : "Переместить выше",
    "Move down" : "Переместить ниже",
    "Pending invitations" : "Ожидающие приглашения",
    "Join conversations from other servers" : "Присоединитесь к обсуждениям на удалённых серверах",
    ...
    "Mentions" : "Упоминания",
    "Meetings" : "Встречи",
    "Sort conversations" : "Сортировать обсуждения",
    "By recent activity" : "По недавней активности",
    "Alphabetically" : "В алфавитном порядке",
    "Do not group by type" : "Не группировать",
    "Show private ones first" : "Показать сначала частные",
    "Show group ones first" : "Показать сначала групповые",
    ...
    "SIP backend is not installed" : "SIP сервер не установлен",
    ...
    "Enable noise suppression" : "Включить подавление шума",
    "Reduce background noises for better voice quality" : "Уменьшить фоновый шум для лучшего качества голоса",
    "Basic" : "Основной",
    "Advanced" : "Дополнительно",
    "Enable echo cancellation" : "Включить подавление эха",
    "Minimize echo effect from own surrounding" : "Уменьшить эффект эха от собственного окружения",
    "Enable auto gain control" : "Включить авторегулировку громкости",
    "Dynamically adjust microphone volume for consistent level" : "Динамически подстраивать громкость микрофона для стабильного уровня",
    ...
    "Recording backend is not installed" : "Сервер записи вызовов не установлен",
    ...
    "Keep pinned for" : "Держать закрепленным:",
    "Set custom period" : "Установить особый период",
    ...
    "This translation is AI generated and may contain mistakes." : "Перевод сгенерирован при помощи AI и может быть неточным",
    "Copy translated text" : "Копировать переведенный текст",
    "Error when scheduling the message" : "Ошибка при планировании сообщения",
    "Reschedule" : "Перенести",
    "Send now" : "Отправить сейчас",
    "Choose a time" : "Выберите время",
    "Send at custom time" : "Отправить в указанное время",
    "Will be sent without notification" : "Будет отправлено без уведомления",
    ...
    "Reply to thread \"{threadTitle}\"" : "Ответить в теме «{threadTitle}»",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Вы проголосовали • %n голос","Вы проголосовали • %n голоса","Вы проголосовали • %n голосов","Вы проголосовали • %n голосов"],
    "You voted" : "Вы проголосовали",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Нажмите для голосования • %n голос","Нажмите для голосования • %n голоса","Нажмите для голосования • %n голосов","Нажмите для голосования • %n голосов"],
    "Click to vote" : "Нажмите для голосования",
    ...
    "_%n vote_::_%n votes_" : ["%n голос","%n голоса","%n голосов","%n голосов"],
    ...
    "Generate summary with AI" : "Сгенерировать резюме с ИИ",
    "{author} (pinned by you)" : "{author} (закреплено Вами)",
    "{author} (pinned by {actor})" : "{author} (закреплено {actor})",
    "Unpin" : "Открепить",
    ...
    "Conversation type" : "Тип обсуждения",
    "Default parameters are:" : "Параметры по умолчанию:",
    "These settings can be changed once the conversation is created." : "Эти настройки можно изменить после создания разговора.",
    ...
    "Message will be sent {datetimeString}" : "Сообщение будет отправлено {datetimeString}",
    ...
    "Message was successfully scheduled" : "Сообщение успешно запланировано",
    ...
    "Show scheduled messages" : "Показать запланированные сообщения",
    ...
    "Voice message {time} ({conversation})" : "Голосовое сообщение {time} ({conversation})",
    ...
    "Allow editing of uploaded files" : "Разрешить редактирование загруженных файлов",
    "Send" : "Отправить",
    ...
    "Can post messages" : "Отправлять сообщения",
    "Can post messages and reactions" : "Отправлять сообщения и реакции",
    "Can add reactions" : "Добавлять реакции",
    "Enable the microphone" : "Включить микрофон",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Результаты опроса • %n голос","Результаты опроса • %n голоса","Результаты опроса • %n голосов","Результаты опроса • %n голосов"],
    "_%n vote • Your vote is anonymous_::_%n votes • Your vote is anonymous_" : ["%n голос • Ваш голос анонимен","%n голоса • Ваш голос анонимен","%n голосов • Ваш голос анонимен","%n голосов • Ваш голос анонимен"],
    "Your vote is anonymous" : "Ваш голос анонимен",
    "You voted for this option" : "Вы проголосовали за этот вариант",
    "End poll" : "Завершить опрос",
    "Change your vote" : "Изменить ваш голос",
    "Withdraw vote" : "Отозвать голос",
    "Results" : "Результаты",
    "Download as spreadsheet" : "Скачать как таблицу",
    ...
    "Pinned by a deleted user" : "Закреплено удаленным пользователем",
    ...
    "I picked the list style" : "Я выбираю в стиле списка",
    ...
    "Chat appearance" : "Внешний вид чата",
    "Messages list" : "Список сообщений",
    "Message bubbles" : "Сообщения в пузырях",
    ...
    "Sounds for chat and call notifications" : "Звуки уведомлений о новых сообщениях или вызове",
    "Invalid language ({languageId})" : "Недопустимый язык ({languageId})",
    "Default language" : "Язык по умолчанию",
    "Default language ({languageName})" : "Язык по умолчанию ({languageName})",
    ...
    "Error when trying to set live translation language" : "Ошибка при попытке установить язык для онлайн-перевода",
    "Set language used to show the transcriptions" : "Установить язык для отображения транскрипции",
    ...
    "Turn camera and microphone off by default" : "Отключить камеру и микрофон по умолчанию",
    "Blur camera background by default" : "Размытие фона камеры по умолчанию",
    "Skip device preview before joining a call" : "Пропустить просмотр устройств перед присоединением к вызову",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Камера будет отключена при присоединении. Всегда отображается, если требуется согласие на запись.",
    "Appearance & Sounds" : "Внешний вид и звуковые уведомления",
    "Privacy" : "Конфиденциальность",
    "Send read receipts" : "Делиться уведомлениями о прочтении",
    "When off, all read statuses will be hidden" : "Если выключено, все уведомления о прочтении будут скрыты",
    "Share typing status" : "Делиться статусом набора текста",
    "When off, all typing indicators will be hidden" : "Если выключено, все статусы набора текста будут скрыты",
    "Attachments folder" : "Папка для вложений",
    "Toggle full screen" : "Переключиться на полный экран",
    "Return to Home screen" : "Вернуться на начальный экран",
    "Shortcuts while in a chat" : "Комбинации клавиш в чате",
    ...
    "The server was updated, you cannot start or join a call." : "Сервер был обновлен, вы не можете начать или присоединиться к вызову.",
    ...
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Обсуждение будет автоматически удалено для всех после %n дня отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n дней отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n дней отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n дней отсутствия активности."],
    ...
    "Scheduled {datetime}" : "Запланировано {datetime} ",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Обсуждение было открыто в другой вкладке. Текущая версия сервера не поддерживает открытие одного обсуждения в нескольких вкладках.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Привет! Ты используешь чат в Конференциях в стиле списка или пузырей?",
    ...
    "Audio" : "Звук",
    "Show all pinned messages" : "Показать все закрепленные сообщения",
    ...
    "The server was updated." : "Сервер был обновлен.",
    ...
    "Error while changing the preserved status of the conversation" : "Не удалось изменить состояние защищенности обсуждения",
    ...
    "Error renaming tag" : "Ошибка переименования тега",
    "Error deleting tag" : "Ошибка удаления тега",
    "Error reordering tags" : "Ошибка изменения порядка тегов",
    ...
    "The server is in maintenance mode." : "Сервер в режиме обслуживания.",
    "Federated server was updated." : "Федеративный сервер был обновлен.",
    ...
    "Connecting is taking longer than expected …" : "Подключение занимает больше времени чем ожидалось …",
    "Failed to connect. Retrying …" : "Не удалось подключиться. Повторная попытка …",
    "Failed to connect. The signaling server may be set up incorrectly" : "Не удалось подключиться. Сигнальный сервер может быть неверно настроен",
